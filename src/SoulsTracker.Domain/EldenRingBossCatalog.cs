...
internal static class EldenRingBossCatalog
{
    ...
    [
        ...
        "Erdtree Avatar", "Erdtree Burial Watchdog (Stormfoot Catacombs)", "Erdtree Burial Watchdog (Impaler's Catacombs)", "Flying Dragon Agheel", "Godrick",
        ...
        "Rennala", "Royal Knight Loretta", "Royal Revenant", "Spirit-Caller Snail", "Tibia Mariner (Liurnia)",
        ...
        "Putrid Avatar (West Caelid)", "Putrid Avatar (East Caelid)", "Putrid Tree Spirit", "Putrid Crystalian Trio", "Radahn (Starscourge)",
        ...
        "Godskin Noble", "Kindred of Rot", "Magma Wyrm (Seethewater Cave)", "Ulcerated Tree Spirit (Mt. Gelmir)", "God-Devouring Serpent / Rykard",
        ...
        "Esgar, Priest of Blood", "Fell Twins", "Grave Warden Duelist (Auriza Side Tomb)", "Godfrey (Golden Shade)", "Morgott",
        ...
        "Ulcerated Tree Spirit (Giants' Mountaintop Catacombs)", "Ancestor Spirit", "Dragonkin Soldier", "Mohg", "Dragonkin Soldier of Nokstella",
        "Beast Clergyman / Maliketh", "Dragonlord Placidusax", "Godskin Duo", "Black Blade Kindred (Bestial Sanctum)", "Night's Cavalry (Forbidden Lands)",
        ...
        "Great Wyrm Theodorix", "Loretta, Knight of the Haligtree", "Malenia", "Misbegotten Crusader", "Night's Cavalry (Consecrated Snowfield Duo)",
        "Putrid Avatar (Consecrated Snowfield)", "Putrid Grave Warden Duelist", "Stray Mimic Tear", "Godfrey (Hoarah Loux)",
        "Gideon Ofnir", "Radagon / Elden Beast",
    ];
    ...
    [
        ...
        "Lamenter", "Rellana", "Red Bear", "Black Knight Edreed", "Black Knight Garrew", "Commander Gaius",
        ...
        "Golden Hippopotamus", "Messmer", "Metyr, Mother of Fingers", "Rakshasa", "Ralva the Great Red Bear", "Tree Sentinel (Duo)",
        "Death Knight (Scorpion River Catacombs)", "Divine Beast Dancing Lion (Rauh Ancient Ruins)", "Romina", "Rugalea the Great Red Bear",
        ...
        "Midra, Lord of Frenzied Flame", "Fallingstar Beast (Finger Ruins)", "Scadutree Avatar", "Radahn (Promised Consort)", "Jagged Peak Drake (Upper)",
